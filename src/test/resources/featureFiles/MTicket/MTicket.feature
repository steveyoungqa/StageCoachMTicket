...
Feature: Debug
  ...
  Scenario Outline: All Feature file Steps in one place
...
#    Then I select to Close the Hamburger Menu
    ...
    Examples:
      ...
      | Galaxy_S7_Edge_API_22 | 5.1     | /Users/steveyoung/Documents/Repos/stagecoach-mticket-automation/m-ticket-rspa.apk | klaudia@dogfi.sh | Password2 | Appium Demo Steve |
